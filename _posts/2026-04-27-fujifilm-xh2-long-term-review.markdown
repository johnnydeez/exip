---
layout: post
title: Fujifilm X-H2 Long-Term Review
author: john
categories: [opinion, photography, cameras]
---
...
![man-on-phone-in-restraunt]({{ site.storageurl }}/man_on_phone_restaurant.jpg){:class="img-responsive" loading="lazy"}
...
![photo-of-a-tram-hiroshima]({{ site.storageurl }}/cinematic_tram_shot.jpg){:class="img-responsive" loading="lazy"}
...
![ikebukuro-street-scene]({{ site.storageurl }}/ikebukuro_street_scene.jpg){:class="img-responsive" loading="lazy"}
...
<div class="image-grid">
    <a
        href="{{ site.storageurl }}/man_with_camera.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/man_with_camera.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/salary_man_walking_hotel.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/salary_man_walking_hotel.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/restaurant_front_people.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/restaurant_front_people.jpg");'>
    </a>
</div>

![taxis-in-street-tokyo]({{ site.storageurl }}/tokyo_taxi_street.jpg){:class="img-responsive" loading="lazy"}

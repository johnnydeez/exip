---
layout: post
title: Is the Fujifilm X100VI Worth Buying?
author: john
categories: [Photography, cameras]
---

![fujifilm-x100vi]({{ site.storageurl }}/x100vi_shot.JPG){:class="img-responsive" loading="lazy"}
...
![nakano-street]({{ site.storageurl }}/nakano_street_photo.jpg){:class="img-responsive" loading="lazy"}
...
![italy-travel]({{ site.storageurl }}/dolomites_hotel.jpg){:class="img-responsive" loading="lazy"}
...
<div class="image-grid">
    <a
        href="{{ site.storageurl }}/florence_river_portrait.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/florence_river_portrait.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/ponte_vecchio_river_morning.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/ponte_vecchio_river_morning.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/portrait_at_ponte_vecchio.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/portrait_at_ponte_vecchio.jpg");'>
    </a>
</div>
...
![florence-at-night]({{ site.storageurl }}/florence_night_view.jpg){:class="img-responsive" loading="lazy"}
...
<div class="image-grid">
    <a
        href="{{ site.storageurl }}/santa_maria_del_fiore_detail.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/santa_maria_del_fiore_detail.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/santa_maria_del_fiore_dome.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/santa_maria_del_fiore_dome.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/santa_maria_del_fiore_front.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/santa_maria_del_fiore_front.jpg");'>
    </a>
</div>
...
![duomo-detail-shot]({{ site.storageurl }}/duomo_outside.jpg){:class="img-responsive" loading="lazy"}
...
![dolomites-cow]({{ site.storageurl }}/cow_and_church.jpg){:class="img-responsive" loading="lazy"}
...
![curving-road-in-dolomites]({{ site.storageurl }}/dolomites_road.jpg){:class="img-responsive" loading="lazy"}
...
<div class="image-grid">
    <a
        href="{{ site.storageurl }}/autumn_portrait.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/autumn_portrait.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/duomo_stairs.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/duomo_stairs.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/hotel_breakfast_portrait.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/hotel_breakfast_portrait.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/milan_park.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/milan_park.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/woman_portait_milan.jpg"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/woman_portait_milan.jpg");'>
    </a>
    <a
        href="{{ site.storageurl }}/x100vi_overhead.JPG"
        target="_blank"
        rel="noreferrer noopener"
        style='background-image: url("{{ site.storageurl }}/x100vi_overhead.JPG");'>
    </a>
</div>
